...
HD_PWD='/home/ubuntu2004/workspace/CCU/Digital_Design/HW/HW03/DDLab_HW03.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log add.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source add.tcl -notrace
