...
main	(int argc, char *argv[])
{
    ...
    //
    pCalcLexer		    the_lexer;
    
    pCalcParser             the_parser;
    ...
    the_lexer = CalcLexerNew(input);	    // CalcLexerNew is generated by ANTLR
    ...
    the_parser = CalcParserNew(tstream);
